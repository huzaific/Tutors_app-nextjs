        ...
        <div class="container">
            ...
            <div class="point-held-wrap">
                ...
                <div class="student-premium-member">
                    <ul>
                        <li><span>[학생닉네임표시부분]</span><b> 학생은 프리미엄 회원입니다.</b></li>
                        <li>남은 기간 : 21일(2020-01-01 까지)</li>
                    </ul>
                    <a href="point-recharge.html" target="_self" class="general-btn green-bg">포인트 충전</a>
                </div>
            </div>
...
export default PointStudentTeacher;
