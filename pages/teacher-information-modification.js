const TeacherInformationModification = () => {
    return ( 
        <div class="content">
                ...
                <div class="login-content region-selection-main">
                    ...
                    <form action="">
                        ...
                        <div class="form-group">
                            ...
                            <span>[그루핑선생님1234]님은 그루핑에 신분이 인증되었습니다.</span>
                            <div class="form-row">
                        ...
                        <div class="form-group edit-profile-btn">
                            <button type="button" onclick="location.href='edit-teacher-profile.html';" class="general-btn green-bg">저장하기</button>
                        </div>
                    </form>
                </div>
            </div>
...
export default TeacherInformationModification;
